...
<template>
    <div>
        <!-- Career Hero section -->
        <div class=" bg-purple-300 px-32 pt-32 pb-44 max-[550px]:px-4 max-[1200px]:px-16">
            ...
            <img src="/assets/shapes.png" alt="Hero Image" class=" h-96 w-96 absolute top-0 right-0 object-cover rotate-90 max-[1450px]:hidden" />
        </div>
