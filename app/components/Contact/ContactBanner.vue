...
<template>
    <div class="relative w-full bg-purple-300 text-white text-center lg:py-40 py-32 overflow-hidden">
        ...
        <div class="flex flex-col items-center justify-center gap-4 px-[10%] md:px-[28%]">
            <h1 class="text-5xl md:text-6xl font-bold text-black " data-aos="fade-up">{{ bannerData?.banner.heading }}
            </h1>
            <p class="text-base md:text-lg font-Inter font-thin md:px-10 text-black" data-aos="fade-up"> {{
                bannerData?.banner.subtitle }}</p>
            <button class="bg-white text-black font-semibold px-4 py-2 rounded mt-4" data-aos="fade-up">Ask
                More</button>
        </div>
