...
<template>
    <div class="relative w-full bg-purple-300 text-white py-24 md:py-28 lg:py-36 mt-20">
        <div class="flex flex-col gap-5 justify-center px-10 lg:px-20">
            <h1 class="text-5xl md:text-5xl xl:text-6xl md:w-[50%] lg:w-[60%] font-black text-black"
                data-aos="fade-up">{{ headerData?.heading }}</h1>
            <p class="text-base font-Inter font-thin md:w-[60%] text-black" data-aos="fade-up">{{ headerData?.subtitle
                }}</p>
        </div>
